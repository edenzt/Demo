...
public class 管理员修改课程信息2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					管理员修改课程信息2 window = new 管理员修改课程信息2();
	...
	public void initialize() {
		...
		textField_1.setText(c.getCredit()+"");
		textField_2.setText(c.getTeacher());
		textField_3.setText(c.getTime());
		textField_4.setText(c.getPlace());
		textField_5.setText(c.getTerm());
		textField_6.setText(c.isRequired()+"");
		textField_7.setText(c.getCapacity()+"");
		textField_8.setText(c.getDes());
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					DataProcessing.updateCourse(textField.getText(),credit,required,textField_5.getText(),capacity,textField_2.getText(),textField_3.getText(),textField_4.getText(),textField_8.getText());
